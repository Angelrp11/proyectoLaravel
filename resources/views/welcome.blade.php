...
<body class="antialiased">
    <div class="cabecera flex items-center">
        <div>
            <a href="{{ route('principal') }}"><img width="250px" height="100px" src="../resources/img/Logo.png"
                    alt=""></a>
        </div>
        @if (Route::has('login'))
    ...
    @auth
        <div class="text-center my-5">
            <h2>Entra en tu perfil para reservar una pista</h2>
        </div>


        <div class="contBotones flex justify-center gap-10">
            <div>
    ...
    @else
        ...
        <div class="flex justify-center">
            <div class="contBotones flex justify-center gap-10">
                <div>
                    <a href="{{ route('login') }}"><button class="botones">Entrar</button></a>
                </div>
                <div>
                    <a href="{{ route('register') }}"><button class="botones">Registrarse</button></a>
                </div>
            </div>
        </div>
    @endauth
    ...
    <footer class="text-center lg:text-left bg-gray-100 text-gray-600 mt-8">
        <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
            <div class="mr-12 hidden lg:block">
                <span>Conéctate en nuestras redes sociales:</span>
            </div>
            <div class="flex justify-center">
        ...
        <div class="mx-6 py-10 text-center md:text-left">
            <div class="grid grid-1 md:grid-cols-2 lg gap-8 justify-center">
                <div class="">
                    ...
                    <p>
                        Somos un grupo de alumnos que hemos decidido crear una página web sobre las reservas de una
                        pista de padel.
                    </p>
                </div>
                <div class="">
